...
IAM policies used for the policies of coping data to s3. No aws keys required
Author:  Dharama Rao Bala
Date:  20190613
Version: 1.0
'''
...
BACKUP_BUCKET = 'influx-backup-devops'
UPLOAD_FOLDER = 'influx-db/Non-Prod'
